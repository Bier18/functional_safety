...
namespace functional_safety
{
  class SafetyTools
  {
    public:
      ...
      virtual void checkVelocityLimits(const std::shared_ptr<geometry_msgs::msg::TwistWithCovariance> msg) = 0; 
      //controlla che le velocità dei giunti rimangano nei range
      ...
      virtual void overrideControl() = 0; //permette il passaggio in modalità manuale
